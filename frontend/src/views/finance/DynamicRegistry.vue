  ...
  <div class="space-y-6 animate-fade-in text-slate-800 font-sans pb-32">
    ...
    <div class="flex flex-col xl:flex-row items-start xl:items-center justify-between gap-6 bg-white p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] border border-slate-200 shadow-sm relative overflow-hidden no-print">
      ...
      <div class="relative z-10 w-full">
        ...
        <div class="mt-4 inline-flex items-center gap-2 bg-emerald-50 text-emerald-700 px-4 py-3 rounded-xl text-xs font-black border border-emerald-100">
           <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
           <span>تێبینی: تۆماری گشتی باشترینە بۆ (حەواڵەی هەوایی و مەسروفات). بۆ (گواستنەوەی کاش یان سافکردنی قەرز)، تکایە بزوێنەری حەواڵەکان بەکاربهێنە.</span>
        </div>
      </div>
